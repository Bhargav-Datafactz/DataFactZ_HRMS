...
class BonusPointSettingSectionView(views.DatafactzSectionView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingNavView(views.DatafactzNavView):
    """
...
class BonusPointSettingFormView(views.DatafactzFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingListView(views.DatafactzListView):
    """
...
class EmployeeBonusPointSectionView(views.DatafactzSectionView):
    """
...
class EmployeeBonusPointNavView(views.DatafactzNavView):
    """
    BonusPoint nav view
    """
...
class EmployeeBonusPointFormView(views.DatafactzFormView):
    """
    BonusPointForm View
    """
...
class EmployeeBonusPointListView(views.DatafactzListView):
    """
    BnusPoint list view
    """
