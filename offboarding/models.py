...
class Offboarding(DatafactzModel):
    """
    Offboarding model
    """
...
class OffboardingStage(DatafactzModel):
    """
    Offboarding model
    """
...
class OffboardingStageMultipleFile(DatafactzModel):
    """
...
class OffboardingEmployee(DatafactzModel):
    """
...
class ResignationLetter(DatafactzModel):
    """
    ...
    def to_offboarding_employee(
        ...
        contract_notice_end_date = (
            get_datafactz_model_class(app_label="payroll", model="contract")
...
class OffboardingTask(DatafactzModel):
    """
...
class EmployeeTask(DatafactzModel):
    """
    EmployeeTask model
    """
...
class ExitReason(DatafactzModel):
    """
    ExitReason model
    """
...
class OffboardingNote(DatafactzModel):
    """
    OffboardingNote
    """
...
class OffboardingGeneralSetting(DatafactzModel):
    """
