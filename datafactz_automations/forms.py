"""
datafactz_automations/forms.py
"""
...
from datafactz_automations.models import MODEL_CHOICES, MailAutomation
...
class AutomationForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["also_sent_to"] = DatafactzMultiSelectField(
    ...
    def clean(self):
        ...
        if isinstance(self.fields["also_sent_to"], DatafactzMultiSelectField):
