"""
datafactz_automation/signals.py
...
from datafactz.signals import post_bulk_update, pre_bulk_update
...
def start_automation():
    ...
    Automation signals
    """
    from base.models import DatafactzMailTemplate
    from datafactz_automations.methods.methods import get_model_class, split_query_string
    ...
    @receiver(post_delete, sender=DatafactzMailTemplate)
    @receiver(post_save, sender=DatafactzMailTemplate)
...
def send_automated_mail(
    ...
    from datafactz_automations.methods.methods import evaluate_condition, operator_map
...
def send_mail(request, automation, instance):
    ...
    from datafactz_automations.methods.methods import (
        get_model_class,
