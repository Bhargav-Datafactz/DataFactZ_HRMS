"""
datafactz_automations/views/cbvs.py
"""
...
from datafactz.decorators import login_required, permission_required
from datafactz_automations import models
from datafactz_automations.filters import AutomationFilter
from datafactz_automations.forms import AutomationForm
from datafactz_views.generic.cbv import views


@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("datafactz_automation.view_mailautomation"), name="dispatch"
)
class AutomationSectionView(views.DatafactzSectionView):
    """
    ...
    template_name = "datafactz_automations/section_view.html"
...
class AutomationNavView(views.DatafactzNavView):
    """
    AutomationNavView
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("datafactz_automation.change_mailautomation"), name="dispatch"
)
class AutomationFormView(views.DatafactzFormView):
    """
    AutomationFormView
    """
    ...
    template_name = "datafactz_automations/automation_form.html"
...
class AutomationListView(views.DatafactzListView):
    """
    AutomationListView
    """
...
class AutomationDetailedView(views.DatafactzDetailedView):
    """
