...
class MailAutomation(DatafactzModel):
    """
    MailAutoMation
    """
    ...
    mail_template = models.ForeignKey(DatafactzMailTemplate, on_delete=models.CASCADE)
    ...
    def get_mail_to_display(self):
        ...
        return render_template(
            "datafactz_automations/mail_to.html", {"instance": self, "mappings": mappings}
        )

    def get_mail_cc_display(self):
        employees = self.also_sent_to.all()
        return render_template(
            "datafactz_automations/mail_cc.html", {"employees": employees}
        )
    ...
    def conditions(self):
        return render_template(
            "datafactz_automations/conditions.html", {"instance": self}
        )
