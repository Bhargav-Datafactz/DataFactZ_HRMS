...
from base.models import DatafactzMailTemplate, JobPosition
...
from datafactz.group_by import group_by_queryset as general_group_by
...
def candidates_view(request):
    ...
    mail_templates = DatafactzMailTemplate.objects.all()
...
def email_send(request):
    ...
    bodys = list(
        DatafactzMailTemplate.objects.filter(id__in=template_attachment_ids).values_list(
            "body", flat=True
        )
    )
