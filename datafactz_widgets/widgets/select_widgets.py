...
This module is used to write datafactz form select widgets
"""
...
class DatafactzMultiSelectWidget(forms.Widget):
    """
    DatafactzMultiSelectWidget
    """
    ...
    template_name = "datafactz_widgets/datafactz_multiselect_widget.html"
