...
from datafactz.decorators import apply_decorators
...
class Bot:
    ...
    def __str__(self) -> str:
        return "Datafactz Bot"

    def get_avatar(self):
        return "https://ui-avatars.com/api/?name=DataFactZ+Bot&background=random"
...
def history_tracking(request, obj_id, **kwargs):
    ...
    def _history_tracking(request, obj_id, model):
        ...
        histories = instance.datafactz_history.all()
        ...
        return render(
            request,
            "datafactz_audit/history_tracking.html",
            context,
        )
