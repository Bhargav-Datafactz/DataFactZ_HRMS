...
from datafactz_audit.methods import remove_duplicate_history
...
class AuditTag(models.Model):
    ...
    class Meta:
        ...
        app_label = "datafactz_audit"


class DatafactzAuditInfo(models.Model):
    """
    DatafactzAuditInfo model to store additional info
    """
...
class DatafactzAuditLog(HistoricalRecords):
    """
    Model to store additional information for historical records.
    """

    # def __init__(self, *args, bases=None, **kwargs):
    #     super(DatafactzAuditLog, self).__init__(*args, **kwargs)
    #     self.is_datafactz_audit_log = True
...
def pre_create_datafactz_audit_log(sender, instance, *args, **kwargs):
    """
...
def post_create_datafactz_audit_log(sender, instance, *_args, **kwargs):
    """
    ...
    try:
        ...
        if isinstance(history_instance, DatafactzAuditLog):
