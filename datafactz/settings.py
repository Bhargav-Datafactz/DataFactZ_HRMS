"""
Django settings for datafactz project.
...
WSGI_APPLICATION = "datafactz.wsgi.application"
...
LOCALE_PATHS = [
    join(BASE_DIR, "datafactz", "locale"),
]
