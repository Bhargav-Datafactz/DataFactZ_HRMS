...
from datafactz.datafactz_settings import APP_URLS, DYNAMIC_URL_PATTERNS


def get_datafactz_model_class(app_label, model):
    """
...
def dynamic_attr(obj, attribute_path):
    ...
    for attr in attributes:
        with contextlib.suppress(Exception):
            Contract = get_datafactz_model_class(app_label="payroll", model="contract")
...
def datafactz_users_with_perms(permissions):
    """
