...
This module defines the abstract base model `DataFactZModel` for the DataFactZ HRMS project.
The `DataFactZModel` provides common fields and functionalities for other models within
...
class DatafactzModel(models.Model):
    """
    An abstract base model that includes common fields and functionalities
    for models within the DataFactZ application.
    """
    ...
    datafactz_history = AuditlogHistoryField()
    objects = models.Manager()
    is_active = models.BooleanField(default=True, verbose_name=_("Is Active"))

    class Meta:
        """
        Meta class for DataFactZModel
        """
    ...
    def save(self, *args, **kwargs):
        ...
        super(DatafactzModel, self).save(*args, **kwargs)
...
auditlog.register(DatafactzModel, serialize_data=True)
