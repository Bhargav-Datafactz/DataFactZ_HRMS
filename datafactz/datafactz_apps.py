...
This module is used to register datafactz addons
"""

from datafactz import settings
from datafactz.settings import INSTALLED_APPS

INSTALLED_APPS.append("accessibility")
INSTALLED_APPS.append("datafactz_audit")
INSTALLED_APPS.append("datafactz_widgets")
INSTALLED_APPS.append("datafactz_crumbs")
INSTALLED_APPS.append("datafactz_documents")
INSTALLED_APPS.append("haystack")
INSTALLED_APPS.append("datafactz_views")
INSTALLED_APPS.append("datafactz_automations")
