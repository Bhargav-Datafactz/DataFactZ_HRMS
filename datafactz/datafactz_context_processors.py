"""
datafactz_context_process.py

This module is used to register context processors without effecting the datafactz/settings.py module
"""

from datafactz.settings import TEMPLATES

TEMPLATES[0]["OPTIONS"]["context_processors"].append(
    "datafactz.config.get_MENUS",
)
TEMPLATES[0]["OPTIONS"]["context_processors"].append(
