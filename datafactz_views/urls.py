"""
datafactz_views/urls.py
"""

from django.urls import path

from datafactz_views import views
from datafactz_views.generic.cbv.views import ReloadMessages
...
urlpatterns = [
    ...
    path(
        "generic-delete",
        views.DatafactzDeleteConfirmationView.as_view(),
        name="generic-delete",
    ),
]
