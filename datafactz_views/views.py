...
from datafactz_views.cbv_methods import get_short_uuid, login_required, merge_dicts
from datafactz_views.forms import SavedFilterForm
from datafactz_views.generic.cbv.views import DatafactzFormView, DatafactzListView
...
class ReloadField(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        model: models.DatafactzModel = dynamic_cache["model"]
...
@method_decorator(login_required, name="dispatch")
class SavedFilter(DatafactzFormView):
    """
    SavedFilter
    """
...
class DynamiListView(DatafactzListView):
    """
...
class DatafactzDeleteConfirmationView(View):
    """
