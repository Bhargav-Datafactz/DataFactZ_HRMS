...
from datafactz.filters import FilterSet
from datafactz.group_by import group_by_queryset
from datafactz.datafactz_middlewares import _thread_locals
from datafactz_views import models
from datafactz_views.cbv_methods import (
    get_short_uuid,
    hx_request_required,
    paginator_qry,
    sortby,
...
from datafactz_views.forms import DynamicBulkUpdateForm, ToggleColumnForm
from datafactz_views.templatetags.generic_template_filters import getattribute


@method_decorator(hx_request_required, name="dispatch")
class DatafactzListView(ListView):
    """
    DatafactzListView
    """
    ...
    template_name: str = "generic/datafactz_list_table.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        update_initial_cache(request, CACHE, DatafactzListView)
        ...
        if request and self._saved_filters.get("field"):
            ...
            for group in context["groups"]:
                for instance in group["list"]:
                    instance.ordered_ids = ordered_ids
                    ordered_ids.append(instance.pk)
        CACHE.get(self.request.session.session_key + "cbv")[DatafactzListView] = context
        from datafactz.urls import path, urlpatterns
    ...
    def export_data(self, *args, **kwargs):
        ...
        class DatafactzListViewResorce(resources.ModelResource):
            """
        ...
        book_resource = DatafactzListViewResorce()
...
class DatafactzSectionView(TemplateView):
    """
    Datafactz Template View
    """
    ...
    template_name = "generic/datafactz_section.html"
...
@method_decorator(hx_request_required, name="dispatch")
class DatafactzDetailedView(DetailView):
    """
    HorillDetailedView
    """

    title = "Detailed View"
    template_name = "generic/datafactz_detailed_view.html"
    header: dict = {"title": "DataFactZ", "subtitle": "DataFactZ Detailed View"}
    body: list = []
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        update_initial_cache(request, CACHE, DatafactzDetailedView)
...
@method_decorator(hx_request_required, name="dispatch")
class DatafactzTabView(TemplateView):
    """
    DatafactzTabView
    """

    view_id: str = get_short_uuid(3, "htv")
    template_name = "generic/datafactz_tabs.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        update_initial_cache(request, CACHE, DatafactzTabView)
    ...
    def get_context_data(self, **kwargs):
        ...
        CACHE.get(self.request.session.session_key + "cbv")[DatafactzTabView] = context

        return context


@method_decorator(hx_request_required, name="dispatch")
class DatafactzCardView(ListView):
    """
    DatafactzCardView
    """
    ...
    template_name = "generic/datafactz_card.html"
    context_object_name = "queryset"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        update_initial_cache(request, CACHE, DatafactzCardView)
    ...
    def get_context_data(self, **kwargs):
        ...
        CACHE.get(self.request.session.session_key + "cbv")[DatafactzCardView] = context
        referrer = self.request.GET.get("referrer", "")
        if referrer:
            # Remove the protocol and domain part
            referrer = "/" + "/".join(referrer.split("/")[3:])
...
@method_decorator(hx_request_required, name="dispatch")
class DatafactzFormView(FormView):
    """
    DatafactzFormView
    """
    ...
    template_name = "generic/datafactz_form.html"
    ids_key: str = "instance_ids"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        update_initial_cache(request, CACHE, DatafactzFormView)
    ...
    def get_form(self, form_class=None):
        ...
        if not hasattr(self, "form"):
            ...
            if self.request.method == "GET":
                ...
                for dynamic_tuple in self.dynamic_create_fields:
                    ...
                    form.fields[field].widget.option_template_name = (
                        "datafactz_widgets/select_option.html",
                    )
            ...
            CACHE.get(self.request.session.session_key + "cbv")[DatafactzFormView] = form
            self.form = form
        return self.form


@method_decorator(hx_request_required, name="dispatch")
class DatafactzNavView(TemplateView):
    """
    DatafactzNavView
    ...
    template_name = "generic/datafactz_nav.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        update_initial_cache(request, CACHE, DatafactzNavView)
    ...
    def get_context_data(self, **kwargs):
        ...
        CACHE.get(self.request.session.session_key + "cbv")[DatafactzNavView] = context
        return context


@method_decorator(hx_request_required, name="dispatch")
class DatafactzProfileView(DetailView):
    """
    GenericDatafactzProfileView
    """

    template_name = "generic/datafactz_profile_view.html"
    view_id: str = None
    filter_class: FilterSet = None
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        update_initial_cache(request, CACHE, DatafactzProfileView)
