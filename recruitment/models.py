...
class SurveyTemplate(DatafactzModel):
    """
...
class Recruitment(DatafactzModel):
    """
    Recruitment model
    """
...
class Stage(DatafactzModel):
    ...
    objects = DatafactzCompanyManager(related_company_field="recruitment_id__company_id")
...
class Candidate(DatafactzModel):
    """
    Candidate model
    """
...
from datafactz.signals import pre_bulk_update


class RejectReason(DatafactzModel):
    """
    RejectReason
    """
...
class RejectedCandidate(DatafactzModel):
    """
    RejectedCandidate
    """
...
class StageFiles(DatafactzModel):
...
class StageNote(DatafactzModel):
    """
    StageNote model
    """
...
class RecruitmentSurvey(DatafactzModel):
    """
    ...
    objects = DatafactzCompanyManager(related_company_field="recruitment_ids__company_id")
...
class QuestionOrdering(DatafactzModel):
    """
...
class RecruitmentSurveyAnswer(DatafactzModel):
    """
...
class RecruitmentMailTemplate(DatafactzModel):
...
class SkillZone(DatafactzModel):
    """ "
...
class SkillZoneCandidate(DatafactzModel):
    """
...
class CandidateRating(DatafactzModel):
...
class RecruitmentGeneralSetting(DatafactzModel):
    """
...
class InterviewSchedule(DatafactzModel):
    """
    ...
    objects = DatafactzCompanyManager("candidate_id__recruitment_id__company_id")
...
class CandidateDocumentRequest(DatafactzModel):
    title = models.CharField(max_length=100)
...
class CandidateDocument(DatafactzModel):
