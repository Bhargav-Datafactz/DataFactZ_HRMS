...
from datafactz_widgets.forms import DatafactzForm, orginal_template_name
...
class AllowanceForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["specific_employees"] = DatafactzMultiSelectField(
...
class GeneratePayslipForm(DatafactzForm):
    """
    Form for Payslip
    """
...
class ReimbursementForm(ModelForm):
    ...
    if apps.is_installed("leave"):
        ...
        def get_encashable_leaves(self, employee):
            LeaveType = get_datafactz_model_class(app_label="leave", model="leavetype")
    ...
    def __init__(self, *args, **kwargs):
        ...
        if apps.is_installed("leave"):
            AvailableLeave = get_datafactz_model_class(
