...
class Employee(models.Model):
    ...
    def get_archive_condition(self):
        ...
        if apps.is_installed("onboarding"):
            OnboardingStage = get_datafactz_model_class("onboarding", "onboardingstage")
            OnboardingTask = get_datafactz_model_class("onboarding", "onboardingtask")
        ...
        if apps.is_installed("recruitment"):
            Recruitment = get_datafactz_model_class("recruitment", "recruitment")
            Stage = get_datafactz_model_class("recruitment", "stage")
    ...
    def check_online(self):
        ...
        """
        if apps.is_installed("attendance"):
            Attendance = get_datafactz_model_class("attendance", "attendance")
...
class EmployeeTag(DatafactzModel):
    """
    EmployeeTag Model
    """
...
class EmployeeBankDetails(DatafactzModel):
    """
...
class NoteFiles(DatafactzModel):
...
class EmployeeNote(DatafactzModel):
    """
    EmployeeNote model
    """
...
class PolicyMultipleFile(DatafactzModel):
    """
...
class BonusPoint(DatafactzModel):
    """
...
class Actiontype(DatafactzModel):
    """
    Action type model
    """
...
class DisciplinaryAction(DatafactzModel):
    """
    Disciplinary model
    """
...
class EmployeeGeneralSetting(DatafactzModel):
    """
